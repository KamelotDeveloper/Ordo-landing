# Skill Registry — ERP landing gasoftware
...
- **Stack**: Astro 5 + Tailwind CSS v3 (@astrojs/tailwind)
- **Testing**: ❌ No test runner detected. Strict TDD disabled. Verification is manual.
- **Persistence**: engram-only (no openspec/)
- **SDD workflow**: Mandatory per AGENTS.md. Phases: design → tasks → apply → verify → archive.
- **Conventions**: Mobile-first, inline SVG icons, Inter via Google Fonts, no UI libs, no custom CSS except Layout.astro animations.
- **Brand tokens**: base (#0a0a0a), card (#111827), border (#2d2d2d), accent (#3b82f6)

## Sources scanned

- C:\Users\Giuliano\.config\opencode\skills
...
### branch-pr
- Path: C:\Users\Giuliano\.config\opencode\skills\branch-pr\SKILL.md
...
### chained-pr
- Path: C:\Users\Giuliano\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\Giuliano\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\Giuliano\.config\opencode\skills\comment-writer\SKILL.md
...
### go-testing
- Path: C:\Users\Giuliano\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\Giuliano\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\Giuliano\.config\opencode\skills\judgment-day\SKILL.md
...
### skill-creator
- Path: C:\Users\Giuliano\.config\opencode\skills\skill-creator\SKILL.md
...
### work-unit-commits
- Path: C:\Users\Giuliano\.config\opencode\skills\work-unit-commits\SKILL.md
